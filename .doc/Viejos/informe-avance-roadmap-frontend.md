...
**Referencia:** `.doc/Viejos/plan-mejoras-frontend.md` — primer ítem del roadmap interno (frontend → DDD → PHP 8.5), **no forma parte de la cotización del cliente**
...
*Este documento es de uso interno — a diferencia de `avance-mejoras-julio-2026.md`, no corresponde a trabajo cotizado ni se envía al cliente. Detalle técnico completo en `.doc/Viejos/checklist-frontend-sprint1-quickwins.md`, `.doc/Viejos/checklist-frontend-sprint2-datatable.md`, `.doc/Viejos/checklist-frontend-sprint3-selects.md` y `.doc/Viejos/checklist-frontend-sprint4-datepicker-modal-glightbox-dropzone.md`.*
