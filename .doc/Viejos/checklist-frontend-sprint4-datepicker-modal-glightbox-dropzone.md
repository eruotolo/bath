...
**Origen:** `.doc/Viejos/plan-mejoras-frontend.md` (sección 11, Sprint 4) — roadmap interno, no cotizado al cliente
...
- Este era el último sprint del plan de mejoras frontend (`.doc/Viejos/plan-mejoras-frontend.md`) — con esto el roadmap interno queda completo, 4 de 4.
