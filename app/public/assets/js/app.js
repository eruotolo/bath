/*
Template Name: Blanco Servicios - Bootstrap 5 Admin & Dashboard Template
Author: Themesbrand
Version: 2.1.0
...
(function ($) {
    ...
    var language = localStorage.getItem('Chubby-language');
    // Default Language
    var default_lang = 'sp';
    ...
    function setLanguage(lang) {
        if (document.getElementById('header-lang-img')) {
            ...
            localStorage.setItem('Chubby-language', lang);
            language = localStorage.getItem('Chubby-language');
            getLanguage();
        }
    }
    ...
    function layoutSetting() {
        ...
        body.hasAttribute('data-bs-theme') && body.getAttribute('data-bs-theme') == 'dark'
            ? updateRadio('layout-mode-dark')
