...
<head>
    ...
    <title>Cards | Chubby - Admin & Dashboard Template</title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">With supporting text below as a natural lead-in to additional
                                                     content.</p>
                                <a href="javascript: void(0);"
                                   class="btn btn-primary waves-effect waves-light w-100">Go somewhere</a>
                            </div>
                        </div>
                    </div><!-- end col -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">With supporting text below as a natural lead-in to
                                                     additional content.</p>
                                <a href="javascript: void(0);"
                                   class="btn btn-primary waves-effect waves-light">Go somewhere</a>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="row g-0 align-items-center">
                                <div class="col-md-4">
                                    <img class="card-img img-fluid" src="../assets/images/small/img-2.jpg"
                                         alt="Card image">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="row g-0 align-items-center">
                                ...
                                <div class="col-md-4">
                                    <img class="card-img img-fluid" src="../assets/images/small/img-3.jpg"
                                         alt="Card image">
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card bg-dark border-dark text-light">
                            <div class="card-body">
                                <h5 class="mb-4 text-light"><i class="mdi mdi-alert-circle-outline me-3"></i>Dark Card
                                </h5>
                                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            </div>
                        </div>
