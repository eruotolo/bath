...
<head>
    ...
    <title>User List | Chubby - Admin & Dashboard Template</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">User Lista</h4>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    if ($_SESSION['category'] == 1 ){
                                        ?>
                                        <li><a class="dropdown-item" href="?id=<?php echo $row['uid'] ?>">Editar</a></li>
                                        <li><a class="dropdown-item" href="?id_user=<?php echo $row['uid'] ?>">Inactivar</a></li>
                                        <li><a class="dropdown-item" href="?id_user=<?php echo $row['uid'] ?>">Reset Password</a></li>
                                        <li><a class="dropdown-item cat-admin" href="?id_user=<?php echo $row['uid'] ?>" style="color: #5156be">Set Admin</a></li>
                                        <?php
                                    }else{
                                        ?>
                                    ...
                                    ?>
                                    <?php
                                    if ($_SESSION['username'] == '270396356'){
                                        ?>
                ...
                <div class="table-responsive mb-4">
                    <table class="table align-middle datatable dt-responsive table-check nowrap"
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="../uploads/users/avatar-2.jpg" alt="" class="avatar-sm rounded-circle me-2">
                                <a href="#" class="text-body">Phyllis Gatlin</a>
                            </td>
                            <td>UI/UX Designer</td>
                            <td>phyllisgatlin@Chubby.com</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="../uploads/users/avatar-1.jpg" alt="" class="avatar-sm rounded-circle me-2">
                                <a href="#" class="text-body">James Nix</a>
                            </td>
                            <td>Frontend Developer</td>
                            <td>jamesnix@Chubby.com</td>
                            <td>
                                <div class="d-flex gap-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="../uploads/users/avatar-3.jpg" alt="" class="avatar-sm rounded-circle me-2">
                                <a href="#" class="text-body">Darlene Smith</a>
                            </td>
                            <td>Backend Developer</td>
                            <td>darlenesmith@Chubby.com</td>
                            <td>
                                <div class="d-flex gap-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="../uploads/users/avatar-6.jpg" alt="" class="avatar-sm rounded-circle me-2">
                                <a href="#" class="text-body">Tommy Hayes</a>
                            </td>
                            <td>UI/UX Designer</td>
                            <td>tommyhayes@Chubby.com</td>
                            <td>
                                <div class="d-flex gap-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="../uploads/users/avatar-8.jpg" alt="" class="avatar-sm rounded-circle me-2">
                                <a href="#" class="text-body">Diana Owens</a>
                            </td>
                            <td>Graphic Designer</td>
                            <td>dianaowens@Chubby.com</td>
                            <td>
                                <div class="d-flex gap-2">
                                    <a href="#" class="badge bg-primary-subtle text-primary font-size-11">Photoshop</a>
                                    <a href="#"
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="../uploads/users/avatar-9.jpg" alt="" class="avatar-sm rounded-circle me-2">
                                <a href="#" class="text-body">Paul Sanchez</a>
                            </td>
                            <td>Angular Developer</td>
                            <td>paulsanchez@Chubby.com</td>
                            <td>
                                <div class="d-flex gap-2">
                                    <a href="#" class="badge bg-primary-subtle text-primary font-size-11">Php</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="../uploads/users/avatar-4.jpg" alt="" class="avatar-sm rounded-circle me-2">
                                <a href="#" class="text-body">Gerald Moyer</a>
                            </td>
                            <td>Backend Developer</td>
                            <td>geraldmoyer@Chubby.com</td>
                            <td>
                                <div class="d-flex gap-2">
                                    <a href="#" class="badge bg-primary-subtle text-primary font-size-11">Php</a>
                                    <a href="#" class="badge bg-primary-subtle text-primary font-size-11">Javascript</a>
