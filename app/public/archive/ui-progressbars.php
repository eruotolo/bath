...
<head>
    ...
    <title>Progress Bars | Chubby - Admin & Dashboard Template</title>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="card-title-desc">Add labels to your progress bars by placing text within the
                                    <code class="highlighter-rouge">.progress-bar</code>.</p>
                            </div><!-- end card header -->
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="card-title-desc">The striped gradient can also be
                                                           animated. Add <code>.progress-bar-animated</code> to
                                    <code>.progress-bar</code> to animate the
