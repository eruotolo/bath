...
<head>
    ...
    <title>Jquery Knob | Chubby - Admin & Dashboard Template</title>
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-sm-6">
                                        <div class="text-center" dir="ltr">
                                            ...
                                            <input class="knob" data-width="150" data-fgcolor="#2D5C6C"
                                    ...
                                    <div class="col-xl-4 col-sm-6">
                                        <div class="text-center" dir="ltr">
                                            ...
                                            <input class="knob" data-width="150" data-angleoffset="90"
                                                   data-linecap="round" data-fgcolor="#f1734f" value="35">
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-sm-6">
                                        <div class="text-center" dir="ltr">
                                            ...
                                            <input class="knob" data-width="150" data-min="-15000"
                                                   ...
                                                   value="-11000" data-fgcolor="#ffbf53">
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-sm-6">
                                        <div class="text-center" dir="ltr">
