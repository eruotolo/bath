...
<head>
    ...
    <title>Echarts | Chubby - Admin & Dashboard Template</title>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="mix-line-bar" data-colors='["#2ab57d", "#2D5C6C", "#fd625e"]'
                                     class="e-charts"></div>
                            </div>
                        </div>
                        <!-- end card -->
                ...
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="doughnut-chart"
                                     data-colors='["#2D5C6C", "#ffbf53", "#fd625e", "#4ba6ef", "#2ab57d"]'
                                     class="e-charts"></div>
                            </div>
                        </div>
                        <!-- end card -->
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="pie-chart"
                                     data-colors='["#fd625e", "#2ab57d", "#4ba6ef", "#ffbf53", "#2D5C6C"]'
                                     class="e-charts"></div>
                            </div>
                        </div>
                        <!-- end card -->
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="candlestick-chart" data-colors='["#2D5C6C", "#2ab57d"]' class="e-charts"></div>
                            </div>
                        </div>
                        <!-- end card -->
                    </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="gauge-chart" data-colors='["#2ab57d", "#2D5C6C", "#fd625e"]'
                                     class="e-charts"></div>
                            </div>
                        </div>
                        <!-- end card -->
