...
<head>
    ...
    <title>Coming Soon | Chubby - Admin & Dashboard Template</title>
                ...
                <div class="text-center py-4 py-sm-5">
                    ...
                    <div class="mb-5">
                        <a href="../index.php">
                            <img src="../assets/images/logo-sm.svg" alt="" height="30" class="me-1"><span
                                    class="logo-txt text-white font-size-22">Chubby</span>
                        </a>
                    </div>
                    <h3 class="text-white mt-5">Let's get started with Chubby</h3>
                    ...
                    <form class="app-search mt-5 mx-auto">
                        <div class="position-relative">
                            ...
                            <button class="btn btn-primary" type="button"><i class="bx bx-paper-plane align-middle"></i>
                            </button>
                        </div>
                    </form>
                </div>
