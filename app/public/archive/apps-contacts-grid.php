...
<head>
    ...
    <title>User Grid | Chubby - Admin & Dashboard Template</title>
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                            <div>
                                <ul class="nav nav-pills">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="apps-contacts-grid.php"
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="card text-center">
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <button type="button" class="btn btn-outline-light text-truncate"><i
                                            class="uil uil-envelope-alt me-1"></i> Message
                                </button>
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <div class="mx-auto mb-4">
                                    <img src="../uploads/users/avatar-6.jpg" alt=""
                                         class="avatar-xl rounded-circle img-thumbnail">
                                </div>
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <div class="mx-auto mb-4">
                                    <img src="../uploads/users/avatar-8.jpg" alt=""
                                         class="avatar-xl rounded-circle img-thumbnail">
                                </div>
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <div class="mx-auto mb-4">
                                    <img src="../uploads/users/avatar-9.jpg" alt=""
                                         class="avatar-xl rounded-circle img-thumbnail">
                                </div>
