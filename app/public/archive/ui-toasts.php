...
<head>
    ...
    <title>Toasts | Chubby - Admin & Dashboard Template</title>
                                ...
                                <div class="position-fixed bottom-0 end-0 p-3" style="z-index: 11">
                                    <div id="liveToast" class="toast" role="alert" aria-live="assertive"
                                        ...
                                        <div class="toast-header">
                                            ...
                                            <strong class="me-auto">Chubby</strong>
                                    ...
                                    <div aria-live="polite" aria-atomic="true" class="position-relative">
                                        ...
                                        <div class="toast-container position-absolute top-0 end-0 p-2 p-lg-3">
                                            ...
                                            <div class="toast fade show" role="alert" aria-live="assertive"
                                                 data-bs-autohide="false" aria-atomic="true">
                                                <div class="toast-header">
                                                    <img src="../assets/images/logo-sm.svg" alt="" class="me-2"
                                                         height="18">
                                                    <strong class="me-auto">Chubby</strong>
                                    ...
                                    <div class="position-relative">
                                        <div class="hstack flex-wrap gap-2">
                                            <button type="button" class="btn btn-primary"
                                                    id="borderedToast1Btn">Primary toast
                                            </button>
                                            <button type="button" class="btn btn-success"
                                                    id="borderedToast2Btn">Success toast
                                            </button>
                                            <button type="button" class="btn btn-warning"
                                                    id="borderedTost3Btn">Warning toast
                                            </button>
                                            <button type="button" class="btn btn-danger"
                                                    id="borderedToast4Btn">danger toast
                                            </button>
                                        </div>
                                        ...
                                        <div style="z-index: 11">
                                            <div id="borderedToast2" class="toast overflow-hidden mt-3" role="alert"
                                                 aria-live="assertive"
                                                 aria-atomic="true">
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div aria-live="polite" aria-atomic="true"
                                         class="bd-example bg-light-subtle position-relative" style="height: 300px;">
