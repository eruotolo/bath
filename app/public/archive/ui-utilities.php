...
<head>
    ...
    <title>Utilities | Chubby - Admin & Dashboard Template</title>
                ...
                <div class="row">
                        ...
                        <div class="card card-h-100">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap gap-3 align-items-center">
                                    <img src="../uploads/users/avatar-10.jpg" class="rounded avatar-xl" alt=" ">
                                    <img src="../uploads/users/avatar-10.jpg" class="rounded-top avatar-xl" alt="">
                                    <img src="../uploads/users/avatar-10.jpg" class="rounded-end avatar-xl" alt="">
                                    <img src="../uploads/users/avatar-10.jpg" class="rounded-bottom avatar-xl" alt="">
                                    <img src="../uploads/users/avatar-10.jpg" class="rounded-start avatar-xl" alt="">
                                    <img src="../uploads/users/avatar-10.jpg" class="rounded-circle avatar-xl" alt="">
                    ...
                    <div class="col-xl-4">
                        <div class="card card-h-100">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap gap-2">
                                    <img src="../uploads/users/avatar-10.jpg" class="rounded-0 avatar-xl" alt="">
                                    <img src="../uploads/users/avatar-10.jpg" class="rounded-1 avatar-xl" alt="">
                                    <img src="../uploads/users/avatar-10.jpg" class="rounded-2 avatar-xl" alt="">
                                    <img src="../uploads/users/avatar-10.jpg" class="rounded-3 avatar-xl" alt="">
                                    <img src="../uploads/users/avatar-10.jpg" class="rounded-4 avatar-xl" alt="">
                                    <img src="../uploads/users/avatar-10.jpg" class="rounded-5 avatar-xl" alt="">
                                </div>
                            </div><!-- end cardbody -->
                        </div><!-- end card -->
                    </div><!-- end col -->
                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            <div class="card-header justify-content-between d-flex align-items-center">
                                ...
                                <a href="https://getbootstrap.com/docs/5.2/utilities/flex/#direction" target="_blank"
                                   class="btn btn-sm btn-soft-secondary">Docs <i
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-content-start flex-wrap bg-light border mb-3"
                                ...
                                <div class="d-flex align-content-end flex-wrap bg-light border mb-3"
                                     style="min-height: 182px;">
                                    <div class="p-2 border">Flex item 1</div>
                                    <div class="p-2 border">Flex item 2</div>
                                    <div class="p-2 border">Flex item 3</div>
                                ...
                                <div class="d-flex align-content-center flex-wrap bg-light border mb-3"
                                     style="min-height: 182px;">
                                    <div class="p-2 border">Flex item 1</div>
                                    <div class="p-2 border">Flex item 2</div>
                                    <div class="p-2 border">Flex item 3</div>
                                ...
                                <div class="d-flex align-content-between flex-wrap bg-light border mb-3"
                                     style="min-height: 182px;">
                                    <div class="p-2 border">Flex item 1</div>
                                    <div class="p-2 border">Flex item 2</div>
                                    <div class="p-2 border">Flex item 3</div>
                                ...
                                <div class="d-flex align-content-around flex-wrap bg-light border mb-3"
                                     style="min-height: 182px;">
                                    <div class="p-2 border">Flex item 1</div>
                                    <div class="p-2 border">Flex item 2</div>
                                    <div class="p-2 border">Flex item 3</div>
                                ...
                                <div class="d-flex align-content-stretch flex-wrap bg-light border mb-0"
                                     style="min-height: 182px;">
                                    <div class="p-2 border">Flex item 1</div>
                                    <div class="p-2 border">Flex item 2</div>
                                    <div class="p-2 border">Flex item 3</div>
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p><a href="#" class="pe-none" tabindex="-1"
                                      aria-disabled="true">This link</a> can not be clicked.</p>
                                <p><a href="#" class="pe-auto">This link</a> can be clicked (this is default behavior).
                                </p>
                                <p class="pe-none"><a href="#" tabindex="-1"
                                                      aria-disabled="true">This link</a> can not be clicked because the
                                    <code>pointer-events</code> property is inherited from its parent. However, <a
                                            href="#" class="pe-auto">this link</a> has a
                            ...
                            <div class="card-body">
                                <div class="d-md-flex bg-light">
                                    <div class="overflow-auto p-3 mb-0 me-md-3 bg-light" style="height: 100px;">
                                        ...
                                        <code>.overflow-auto</code> on an element with set width and height dimensions. By design, this content will vertically scroll.
                                    </div>
                                </div>
                            </div><!-- end card body -->
                        </div><!-- end card -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="" style="height: 264px;">
                                    ...
                                    <div class="h-100 p-3 bg-light d-inline-block" style="width: 92px;">Height 100%
                                    </div>
                                    <div class="h-auto p-3 bg-light d-inline-block" style="width: 92px;">Height auto
                                    </div>
                                </div>
                            </div><!-- end cardbody -->
                        </div><!-- end card -->
                            ...
                            <div class="card-body pt-0">
                                <p class="text-muted mb-0">
                                    Muted text with a <a href="#"
                                                         class="text-reset text-decoration-underline">reset link</a>.
                                </p>
                            </div><!-- end card body -->
                            <div class="card-body pt-0">
