...
<head>
    ...
    <title>Read Email | Chubby - Admin & Dashboard Template</title>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="flex-shrink-0 me-3">
                                            <img class="rounded-circle avatar-sm" src="../uploads/users/avatar-2.jpg"
                                        ...
                                        <div class="col-xl-2 col-6">
                                            <div class="card">
                                                ...
                                                <div class="py-2 text-center">
                                                    <a download="img-3.jpg" href="../assets/images/small/img-3.jpg"
                                        ...
                                        <div class="col-xl-2 col-6">
                                            <div class="card">
                                                <img class="card-img-top img-fluid" src="../assets/images/small/img-4.jpg"
                                                     alt="Card image cap">
                                                <div class="py-2 text-center">
                                                    <a download="img-4.jpg" href="../assets/images/small/img-4.jpg"
                                                       class="fw-medium">Download</a>
                                                </div>
                                            </div>
                                        </div>
