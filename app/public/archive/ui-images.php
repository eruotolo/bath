...
<head>
    ...
    <title>Images | Chubby - Admin & Dashboard Template</title>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mt-4 mt-md-0">
                                            <img class="rounded-circle avatar-xl" alt="200x200"
                                                 src="../uploads/users/avatar-4.jpg" data-holder-rendered="true">
                                        </div>
                                    </div><!-- end col -->
                                </div><!-- end row -->
                            </div><!-- end card-body -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="mt-4 mt-md-0">
                                            <img class="img-thumbnail rounded-circle avatar-xl" alt="200x200"
                                                 src="../uploads/users/avatar-3.jpg" data-holder-rendered="true">
                                        </div>
                                    </div><!-- end col -->
                                </div><!-- end row -->
                            </div><!-- end card-body -->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 col-6">
                                                <div>
                                                    <img src="../uploads/users/avatar-4.jpg" alt=""
                                            ...
                                            <div class="col-lg-2 col-6">
                                                <div>
                                                    <img src="../uploads/users/avatar-5.jpg" alt=""
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <img class="rounded avatar-md" src="../uploads/users/avatar-3.jpg"
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 me-3">
                                        <img class="rounded avatar-md" src="../uploads/users/avatar-5.jpg"
                                             alt="Generic placeholder image">
                                    </div>
                                    <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-end">
                                    <div class="flex-shrink-0 me-3">
                                        <img class="rounded avatar-md" src="../uploads/users/avatar-1.jpg"
                                             alt="Generic placeholder image">
                                    </div>
                                    <div class="flex-grow-1">
