...
<head>
    <title>Chartjs | Chubby - Admin & Dashboard Template</title>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <canvas id="lineChart" class="chartjs-chart"
                                        data-colors='["rgba(81, 86, 190, 0.2)", "#2D5C6C", "rgba(235, 239, 242, 0.2)", "#ebeff2"]'></canvas>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <canvas id="pieChart" class="chartjs-chart"
                                        data-colors='["#2ab57d", "#ebeff2"]'></canvas>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <canvas id="doughnut" class="chartjs-chart"
                                        data-colors='["#2D5C6C", "#ebeff2"]'></canvas>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <canvas id="polarArea" class="chartjs-chart"
                                        data-colors='["#fd625e", "#2ab57d", "#ffbf53", "#2D5C6C"]'></canvas>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <canvas id="radar" class="chartjs-chart"
                                        data-colors='["rgba(42, 181, 125, 0.2)", "#2ab57d", "rgba(81, 86, 190, 0.2)", "#2D5C6C"]'></canvas>
                            </div>
                        </div>
                    </div> <!-- end col -->
                </div> <!-- end row -->
