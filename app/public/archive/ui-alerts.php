...
<head>
    ...
    <title>Alerts | Chubby - Admin & Dashboard Template</title>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="alert alert-primary" role="alert">
                                    A simple primary alert with <a href="javascript: void(0);"
                                                                   class="alert-link">an example link</a>. Give it a
                                    click if you like.
                                </div>
                                <div class="alert alert-secondary" role="alert">
                                ...
                                <div class="alert alert-success" role="alert">
                                    A simple success alert with <a href="javascript: void(0);"
                                                                   class="alert-link">an example link</a>. Give it a
                                    click if you like.
                                </div>
                                <div class="alert alert-danger" role="alert">
                                    A simple danger alert with <a href="javascript: void(0);"
                                                                  class="alert-link">an example link</a>. Give it a
                                    click if you like.
                                </div>
                                <div class="alert alert-warning" role="alert">
                                    A simple warning alert with <a href="javascript: void(0);"
                                                                   class="alert-link">an example link</a>. Give it a
                                    click if you like.
                                </div>
                                <div class="alert alert-info" role="alert">
                                    A simple info alert with <a href="javascript: void(0);"
                                                                class="alert-link">an example link</a>. Give it a click
                                    if you like.
                                </div>
                                <div class="alert alert-light" role="alert">
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="card-title-desc">Add a dismiss button and the
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="card-title-desc">Add
                                    <code>.alert-outline</code> class with for Outline alerts.</p>
                            </div><!-- end card header-->
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-info alert-dismissible alert-outline fade show mb-0"
                                     role="alert">
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-info alert-border-left alert-dismissible fade show mb-0"
                                     role="alert">
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="card-title-desc">Add <code>.alert-top-border</code> class with for top alerts.
                                </p>
                            </div><!-- end card header-->
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="card-title-desc">Alert label add
                                    <code>.alert-heading</code> class with additional content example</p>
                            </div><!-- end card header-->
