...
<head>
    ...
    <title>Dropdowns | Chubby - Admin & Dashboard Template</title>
                            ...
                            <div class="card-header">
                                ...
                                <p class="card-title-desc">Any single <code
                                            class="highlighter-rouge">.btn</code> can be turned into a dropdown
                                                           ...
                                                           with either <code
                                            class="highlighter-rouge">&lt;button&gt;</code>
                                                           elements:
                                </p>
                            </div><!-- end card header -->
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="card-title-desc">Option into darker dropdowns to match a dark navbar or custom style by adding
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="card-title-desc">Add <code class="highlighter-rouge">.dropdown-menu-end</code>
                                                           to a <code
                                            class="highlighter-rouge">.dropdown-menu</code> to right
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="card-title-desc">Trigger dropdown menus at the down of the elements by adding
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="card-title-desc">Trigger dropdown menus above elements
                                                           by adding <code
                                            class="highlighter-rouge">.dropup</code> to the parent
                                                           element.</p>
                            </div><!-- end card header -->
