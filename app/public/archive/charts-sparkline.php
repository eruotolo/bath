...
<head>
    ...
    <title>Sparkline | Chubby - Admin & Dashboard Template</title>
                ...
                <div class="row">
                    <div class="col-xl-4 col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="sparkline1" data-colors='["#2ab57d", "#2D5C6C", "#e9ecef"]'
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body analytics-info">
                                <div id="sparkline4" data-colors='["#2D5C6C"]'></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="sparkline3" data-colors='["#2D5C6C", "#2ab57d"]' class="text-center"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="sparkline5"
                                     data-colors='["#2D5C6C", "rgba(81, 86, 190, 0.3)", "#2ab57d", "rgba(42, 181, 125, 0.3)"]'
                                     class="text-center"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="sparkline7" data-colors='["#2D5C6C", "#fd625e"]' class="text-center"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-sm-6">
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="sparkline9" data-colors='["#2D5C6C", "#2ab57d", "#f46a6a"]'
                                     class="text-center"></div>
                            </div>
                        </div>
                    </div>
