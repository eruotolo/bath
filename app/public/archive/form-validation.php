...
<head>
    ...
    <title>Validation | Chubby - Admin & Dashboard Template</title>
                                ...
                                <div>
                                    ...
                                    <form id="pristine-valid-example" novalidate method="post">
                                            ...
                                            <div class="col-xl-4 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" required
                                                           data-pristine-required-message="Please Enter a username"
                                            ...
                                            <div class="col-xl-4 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number" min="14"
                                                           data-pristine-min-message="You must be at least 14-years-old"
                                                           required class="form-control" value="10"
                                        ...
                                        <div class="form-group mb-3 form-check">
                                            <input id="term-check01" type="checkbox" class="form-check-input"
                                                   name="future" required
                                                   data-pristine-required-message="You must accept the terms and conditions"/>
                                            <label class="form-check-label"
                                                   for="term-check01">I accept the terms and conditions</label><br/>
                                        </div>
                                        ...
                                        <div class="form-group mb-3 inline-label">
                                            ...
                                            <div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" id="hobbiecheck01" type="checkbox"
                                                           min="2" name="hobbie" required
                                                           data-pristine-min-message="Select at least 2"/>
                                                    <label class="form-check-label" for="hobbiecheck01">Writing</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" id="hobbiecheck02" type="checkbox"
                                                           min="2" name="hobbie" required
                                                           data-pristine-min-message="Select at least 2"/>
                                                    <label class="form-check-label"
                                                           for="hobbiecheck02">Photography</label><br/>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" id="hobbiecheck03" type="checkbox"
                                                           min="2" name="hobbie" required
                                                           data-pristine-min-message="Select at least 2"/>
                                            ...
                                            <div class="col-xl-4 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number" pattern="/^\d+\.\d{2}$/g" required
                                                           class="form-control"
                                                           placeholder="Two decimal digits with two points"/>
                                                </div>
                                            </div>
                                            <div class="col-xl-4 col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number" pattern="/^\d+\.\d{2}$/g" required
                                                           ...
                                                           class="form-control" placeholder="Write custom message"/>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <form id="pristine-valid-specificfield" novalidate method="post">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" required id="specificfield"
                                                   placeholder="Enter first letter capitalized"/>
                                        </div>
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary">Submit form</button>
                                        </div>
