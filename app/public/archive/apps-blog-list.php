...
<head>
    <title>Blog List | Chubby - Admin & Dashboard Template</title>
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                            <div>
                                <ul class="nav nav-pills">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="apps-blog-list.php" data-bs-toggle="tooltip"
                                           data-bs-placement="top" title="List"><i class="bx bx-list-ul"></i></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="apps-blog-grid.php" data-bs-toggle="tooltip"
                    ...
                    <div class="col-xl-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    <a href="#" class="align-middle font-size-15">Read more <i
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-5">
                                    ...
                                    <ul class="list-unstyled fw-medium px-2">
                                        <li><a href="javascript: void(0);" class="text-body pb-3 d-block border-bottom">Design<span
                                                        class="badge bg-primary-subtle text-primary rounded-pill ms-1 float-end font-size-12">02</span></a>
                                        </li>
                                        <li><a href="javascript: void(0);" class="text-body py-3 d-block border-bottom">Development
                                                <span class="badge bg-primary-subtle text-primary rounded-pill float-end ms-1 font-size-12">04</span></a>
                                        </li>
                                        <li><a href="javascript: void(0);" class="text-body py-3 d-block border-bottom">Business<span
                                                        class="badge bg-primary-subtle text-primary rounded-pill ms-1 float-end font-size-12">12</span></a>
                                        </li>
                                        <li><a href="javascript: void(0);" class="text-body py-3 d-block border-bottom">Project<span
                                                        class="badge bg-primary-subtle text-primary rounded-pill ms-1 float-end font-size-12">08</span></a>
                                        </li>
                                        <li><a href="javascript: void(0);"
                                               class="text-body pt-3 pb-0 d-block">Travel<span
                                                        class="badge bg-primary-subtle text-primary rounded-pill ms-1 float-end font-size-12">10</span></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="mt-5">
                                           ...
                                           class="list-group-item text-muted pb-3 pt-0 px-2">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    ...
                                                    <p class="mb-0 text-truncate">20 August, 2022 <span
                                                                class="">/ 05:00 AM</span></p>
                                                </div>
                                                <div class="fs-1">
                                ...
                                <div class="mt-5">
                                    ...
                                    <div class="px-2">
                                        <a href="#" class="font-size-17"><span
                                                    class="badge bg-primary-subtle text-primary">Design</span></a>
                                        <a href="#" class="font-size-17"><span
                                                    class="badge bg-primary-subtle text-primary">Development</span></a>
                                        <a href="#" class="font-size-17"><span
                                                    class="badge bg-primary-subtle text-primary">Wordpress</span></a>
                                        <a href="#" class="font-size-17"><span
                                                    class="badge bg-primary-subtle text-primary">HTML</span></a>
                                        <a href="#" class="font-size-17"><span
                                                    class="badge bg-primary-subtle text-primary">Project</span></a>
                                        <a href="#" class="font-size-17"><span
                                                    class="badge bg-primary-subtle text-primary">Business</span></a>
                                        <a href="#" class="font-size-17"><span
                                                    class="badge bg-primary-subtle text-primary">Travel</span></a>
                                        <a href="#" class="font-size-17"><span
                                                    class="badge bg-primary-subtle text-primary">Photography</span></a>
                                    </div>
                                </div>
                                        ...
                                        <div class="input-group mb-0 px-2">
                                            ...
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i
                                                            class="mdi mdi-send-outline"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
