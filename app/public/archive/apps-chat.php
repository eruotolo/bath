...
<head>
    ...
    <title>Chat | Chubby - Admin & Dashboard Template</title>
                        ...
                        <div class="p-3 px-4 border-bottom">
                            <div class="d-flex align-items-start ">
                                <div class="flex-shrink-0 me-3 align-self-center">
                                    <img src="../uploads/users/avatar-1.jpg" class="avatar-sm rounded-circle" alt="">
                                </div>
                                                    ...
                                                    <a href="#">
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div class="flex-shrink-0 user-img online align-self-center me-3">
                                                                <img src="../uploads/users/avatar-2.jpg"
                                                    ...
                                                    <a href="#">
                                                        <div class="d-flex align-items-start">
                                                            <div class="flex-shrink-0 user-img away align-self-center me-3">
                                                                <img src="../uploads/users/avatar-3.jpg"
                                                                     class="rounded-circle avatar-sm" alt="">
                                                                <span class="user-status"></span>
                                                            </div>
                                                    ...
                                                    <a href="#">
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div class="flex-shrink-0 user-img align-self-center me-3">
                                                                <img src="../uploads/users/avatar-4.jpg"
                                                                     class="rounded-circle avatar-sm" alt="">
                                                                <span class="user-status"></span>
                                                            </div>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div class="flex-shrink-0 user-img align-self-center me-3">
                                                                <img src="../uploads/users/avatar-5.jpg"
                                                                     class="rounded-circle avatar-sm" alt="">
                                                                <span class="user-status"></span>
                                                            </div>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div class="flex-shrink-0 user-img align-self-center me-3">
                                                                <img src="../uploads/users/avatar-6.jpg"
                                                                     class="rounded-circle avatar-sm" alt="">
                                                                <span class="user-status"></span>
                                                            </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="font-size-14 mb-1 text-truncate"><a href="#"
                                                                                               class="text-dark">Jennie Sherlock</a>
                                                </h5>
                                        ...
                                        <div class="conversation-list">
                                            <div class="ctext-wrap">
                                                <div class="ctext-wrap-content">
                                                    <h5 class="conversation-name"><a href="#"
                                                                                     class="user-name">Jennie Sherlock</a>
